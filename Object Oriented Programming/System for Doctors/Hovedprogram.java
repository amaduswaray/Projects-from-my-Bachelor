  ...
  public static void main(String[] args) throws UlovligUtskrift{
    ...
    while(avslutt != 0){
      ...
      if(skan.nextLine().equals("q")){
        ...
        System.out.println("5: Lese inn data fra fil.");
        System.out.println("6: Skrive ut hele legesystemet.");
        ...
        if(guide.equals("1")){
          ...
          if(svar.toLowerCase().equals("pasient")){
          ...
          else if(svar.toLowerCase().equals("legemiddel")){
            ...
            else if(type.toLowerCase().equals("narkotisk")){
            ...
            else if(type.toLowerCase().equals("nanedannende")){
          ...
          else if(svar.toLowerCase().equals("lege")){
            System.out.println("Du har valgt aa legge til en Lege.");
              ...
              System.out.println("Husk ingen mellomrom etter komma. KontrollID = 0 hvis det er en vanlig lege.");
          ...
          else if(svar.toLowerCase().equals("resept")){
          ...
          System.out.println("Du har valgt aa lese inn data fra en fil.");
          System.out.println("Skriv inn filnavnet du har lyst til aa lese inn fra, paa dette formatet:");
          System.out.println("filnavn.txt");

          String filnavn = skan.nextLine();
          system.lesInnfil(filnavn);

          System.out.println("Fil har blitt lest og objektene er lagt til i legesystemet.")
        ...
        else if(guide.equals("6")){

          system.skriv();

          System.out.println("Trykk en tast far aa gaa til meny.");
